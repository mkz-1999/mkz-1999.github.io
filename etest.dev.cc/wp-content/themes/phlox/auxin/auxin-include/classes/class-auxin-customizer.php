...
class Auxin_Customizer{
    ...
    public function customize_register( WP_Customize_Manager $wp_customize ){
        ...
        // Go Pro section ----
        $wp_customize->add_section( new Auxin_Customize_Link_Section( $wp_customize, 'gopro-section' , array(
            'title'        => __( 'More Customization', 'phlox' ),
            'priority'     => 1,
        ...
        switch ( $field['type'] ) {
            ...
            case 'images':
                ...
                $control_args['button_labels'] = array(
                    'add'          => esc_attr__( 'Add Image', 'phlox' ),
                    'change'       => esc_attr__( 'Change Image', 'phlox' ),
                    'submit'       => esc_attr__( 'Submit Image', 'phlox' ),
                    'frame_title'  => esc_attr__( 'Select Image', 'phlox' ),
                    'frame_button' => esc_attr__( 'Choose Image', 'phlox' )
                );
            ...
            case 'audio':
                ...
                $control_args['multiple']      = '0';
                $control_args['button_labels'] = array(
                    'add'          => esc_attr__( 'Add Audio', 'phlox' ),
                    'change'       => esc_attr__( 'Change Audio', 'phlox' ),
                    'submit'       => esc_attr__( 'Submit Audio', 'phlox' ),
                    'frame_title'  => esc_attr__( 'Select Audio', 'phlox' ),
                    'frame_button' => esc_attr__( 'Choose Audio', 'phlox' )
                );
                $control_type_class = 'Auxin_Customize_Media_Control';
                break;
            ...
            case 'video':
                ...
                $control_args['multiple']      = '0';
                $control_args['button_labels'] = array(
                    'add'          => esc_attr__( 'Add Video', 'phlox' ),
                    'change'       => esc_attr__( 'Change Video', 'phlox' ),
                    'submit'       => esc_attr__( 'Submit Video', 'phlox' ),
                    'frame_title'  => esc_attr__( 'Select Video', 'phlox' ),
                    'frame_button' => esc_attr__( 'Choose Video', 'phlox' )
                );
                $control_type_class = 'Auxin_Customize_Media_Control';
                break;
